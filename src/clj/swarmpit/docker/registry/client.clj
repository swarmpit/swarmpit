...
(defn- request-manifest
  [token repository-name repository-tag type]
...
(defn manifest
  ...
  (:body (request-manifest token repository-name repository-tag
                           "application/vnd.docker.distribution.manifest.v1+prettyjws")))

(defn digest
  [token repository-name repository-tag]
  (-> (or (request-manifest token repository-name repository-tag
                            "application/vnd.docker.distribution.manifest.list.v2+json")
          (request-manifest token repository-name repository-tag
