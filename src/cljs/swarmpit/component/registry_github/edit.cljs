(ns swarmpit.component.registry-github.edit
                   ...
                   (when origin?
                     (dispatch!
                       (routes/path-for-frontend :registry-info {:registryType :github
                                                                 :id           registry-id})))
                   (message/info
                     (str "Github registry " registry-id " has been updated.")))
     :on-error   (fn [{:keys [response]}]
                   (message/error
                     (str "Github registry update failed. " (:error response))))}))
          ...
          (comp/card
            ...
            (comp/card-content
              ...
              (comp/typography
                ...
                "Update Github account settings")
